...
from musubi_tuner.minimax_h3_native_generate_video import load_cached_text_conditioning, validate_generation_args
...
def test_generation_orchestrates_t2va_sampling_decode_and_mux_without_co_resident_vaes(tmp_path, monkeypatch):
    import musubi_tuner.minimax_h3_native_generate_video as generate
