...
MINIMAX_H3_DEFAULTS = {
    ...
    "minimax_h3_audio_loss_weight": "1.0",
    "minimax_h3_shift_video": "12.0",
    "minimax_h3_shift_audio": "3.0",
    ...
    "minimax_h3_text_encoder_attn_mode": "sdpa",
    "minimax_h3_guidance_uncond_cache": "",
...
FIELD_LABELS = {
    ...
    "minimax_h3_audio_vae": "Official MiniMax Audio VAE",
    "minimax_h3_video_only": "Train Video Only (Ignore Audio Loss)",
    ...
    "minimax_h3_text_encoder_blocks_to_swap": "Text Encoder Low-VRAM Streaming",
    ...
    "minimax_h3_guidance_distillation_sigma_min": "Protection Minimum Sigma",
    "minimax_h3_training_assistant": "Ostris Training Assistant",
    "minimax_h3_foundation_lora_enabled": "Train on Top of an Existing LoRA",
    "minimax_h3_foundation_lora": "Foundation LoRA",
    "minimax_h3_foundation_lora_multiplier": "Foundation Strength",
...
CHOICES = {
    ...
    "timestep_sampling": ["sigma", "uniform", "sigmoid", "shift", "flux_shift", "krea2_shift", "h3_shifted_uniform"],
