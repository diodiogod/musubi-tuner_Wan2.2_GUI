...
from musubi_tuner.minimax_h3_native.media import H3Record, H3Task
...
def load_h3_text_encoder(
    ...
    *,
    ...
    from musubi_tuner.modules.nvfp4_native_utils import NvFp4Quantizer, apply_nvfp4_monkey_patch
